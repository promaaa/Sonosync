...
export const Icons = {
    ...
    deezer: ({ className }: { className?: string }) => (
        <div
            className={cn("bg-current", className)}
            style={{
                mask: `url('/icons/deezer.png') center/contain no-repeat`,
                WebkitMask: `url('/icons/deezer.png') center/contain no-repeat`,
            }}
        />
    ),
    apple: ({ className }: { className?: string }) => (
        <div
            className={cn("bg-current", className)}
            style={{
                mask: `url('/icons/applemusic.png') center/contain no-repeat`,
                WebkitMask: `url('/icons/applemusic.png') center/contain no-repeat`,
            }}
        />
    ),
